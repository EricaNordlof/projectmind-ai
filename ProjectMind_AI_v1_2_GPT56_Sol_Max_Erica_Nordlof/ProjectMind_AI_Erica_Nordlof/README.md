...
ProjectMind AI använder nu **GPT-5.6 Sol** som standardmodell via OpenAI Responses API.

Standard:
- `OPENAI_MODEL=gpt-5.6-sol`
- `OPENAI_REASONING_EFFORT=max`

`max` använder Sols högsta tillgängliga resonemangsnivå för svåra projektfrågor, kod,
felsökning och bildanalys. Det kan ge längre svarstid och högre API-kostnad än lägre nivåer.
